...
/****************************************************************************************************/
		...
		{ PORTF, PN0, NON_CONFIGURED_PIN, MODE_DIO, NON_CONFIGUERED_DIRECTION,
			NON_CONFIGUERED_ATTACH, PIN_LOW, CURRENT_2MA, SET_DIGITAL_ENABLE }, /* PORTF-PIN0*/
		...
		{ PORTF, PN3, NON_CONFIGURED_PIN, MODE_DIO, NON_CONFIGUERED_DIRECTION,
			NON_CONFIGUERED_ATTACH, PIN_LOW, CURRENT_2MA, SET_DIGITAL_ENABLE }, /* PORTF-PIN3*/

		{ PORTF, PN4, NON_CONFIGURED_PIN, MODE_DIO, NON_CONFIGUERED_DIRECTION,
			NON_CONFIGUERED_ATTACH, PIN_LOW, CURRENT_2MA, SET_DIGITAL_ENABLE }, /* PORTF-PIN4*/
};
/**********************************************************************************************************************
